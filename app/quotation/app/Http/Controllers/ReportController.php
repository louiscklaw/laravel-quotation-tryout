...
class ReportController extends Controller
{
    ...
    public function get_sample_bar_chart()
    {
        return app()->chartjs
        ->name('bar')
        ->type('bar')
    ...
    public function get_sample_horizontal_bar_chart()
    {
        return app()->chartjs
        ->name('horizontalBar')
        ->type('horizontalBar')
    ...
    public function index()
    {
        ...
        $sample_bar_chart = $this->get_sample_bar_chart();
        $sample_line_chart = $this->get_sample_line_chart();
        $sample_donghunt_chart = $this->get_sample_doughnut();
        $sample_horizontal_bar_chart = $this->get_sample_horizontal_bar_chart();
