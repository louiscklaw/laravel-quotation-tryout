                                    ...
                                    @else
                                        ...
                                        @for($i=0; $i<sizeof($quot['quotitems']); $i++)
                                            <tr>
                                                ...
                                                <td class="col-sm-6">
                                                    {{Form::text('quotitem'.'[name]'.'[]', $quot['quotitems'][$i]->quotitem_name,['class'=>'form-control'])}}
                                                </td>
                                                <td class="col-sm-1">
                                                    {{Form::text('quotitem'.'[quantity]'.'[]', $quot['quotitems'][$i]->quotitem_quantity,['class'=>'form-control'])}}

                                                </td>
                                                <td class="col-sm-1">
                                                    {{Form::text('quotitem'.'[unitprice]'.'[]', $quot['quotitems'][$i]->quotitem_unitprice,['class'=>'form-control'])}}

                                                </td>
                                                <td class="col-sm-1">
                                                    {{Form::text('quotitem'.'[subtotal]'.'[]', $quot['quotitems'][$i]->quotitem_subtotal,['class'=>'form-control'])}}
                                                </td>
...
@push('blank_scripts_body')
        ...
        $(document).ready(function () {
            ...
            $("#addrow").on("click", function () {
                ...
                cols += '<td>'+counter+'</td>';
                cols += '<td><input type="text" class="form-control" name="quotitem[name][]"/></td>';
                cols += '<td><input type="text" class="form-control" name="quotitem[quantity][]"/></td>';
                cols += '<td><input type="text" class="form-control" name="quotitem[unitprice][]"/></td>';
                cols += '<td><input type="text" class="form-control" name="quotitem[subtotal][]"/></td>';
