...
<table style="padding-top: 20px;">
    <tr>
        <td>2.</td>
        <td>Leasing will be extended automatically until we have received your formal notice . Collection could be make at least 1 day before.</td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td>4.</td>
        <td>We will delivery you the above components and you agree to pay the above listed price, if component(s) is (are) lost , damaged or cleaning.</td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td colspan=2 style="text-align: center; padding-top:20px;">If you have any query, please feel free to contact WELLTECH AERIAL ENGINEERING CO., LTD. at 2388 8116.</td>
    </tr>
</table>
